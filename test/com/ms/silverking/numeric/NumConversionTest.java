...
public class NumConversionTest {
	...
	private static final byte[] long_max      = {byte_maxVal, byte_maxVal, byte_maxVal, byte_maxVal, byte_maxVal, byte_maxVal, byte_maxVal, byte_maxVal};
	...
	private static final byte[] int_min       = {   long_min[firstIndex],    long_min[firstIndex+1],    long_min[firstIndex+2],    long_min[firstIndex+3]};
	private static final byte[] int_negOne    = {long_negOne[firstIndex], long_negOne[firstIndex+1], long_negOne[firstIndex+2], long_negOne[firstIndex+3]};
	private static final byte[] int_zero      = {  long_zero[firstIndex],   long_zero[firstIndex+1],   long_zero[firstIndex+2],   long_zero[firstIndex+3]};
	private static final byte[] int_one       = {   long_one[firstIndex],    long_one[firstIndex+1],    long_one[firstIndex+2],    long_one[firstIndex+3]};
	private static final byte[] int_max       = {   long_max[firstIndex],    long_max[firstIndex+1],    long_max[firstIndex+2],    long_max[firstIndex+3]};
...
//			{new byte[]{},  false, 0, false},
			{byte_min,       true, 0,  true},
			{byte_negOne,    true, 0,  true},
			{byte_zero,     false, 0, false},
			{byte_one,       true, 0,  true},
			{byte_max,       true, 0,  true},
			{byte_minToMax,  true, 0,  true},
			{byte_minToMax,  true, 2, false},
			{byte_minToMax,  true, 4,  true},
		};
	...
	private void checkByteToBoolean(byte[] bytes, boolean expected, int offset, boolean offsetExpected) {
		...
		assertEquals(getTestMessage(testName, bytesString, offset), offsetExpected, NumConversion.byteToBoolean(bytes, offset));
	}
	...
	public void testBytesToShort() {
		Object[][] testCases = {
			{short_min,     -32_640, 0, -32_640},
			{short_negOne,       -1, 0,      -1},
			{short_zero,          0, 0,       0},
			{short_one,         257, 0,     257},
			{short_max,      32_639, 0,  32_639},
			{byte_minToMax, -32_513, 0, -32_513},
			{byte_minToMax, -32_513, 2,       1},
			{byte_minToMax, -32_513, 3,     383},
		};
	...
	private void checkBytesToShort(byte[] bytes, short expected, int offset, short offsetExpected) {
		...
		assertEquals(getTestMessage(testName, bytesString, offset), offsetExpected, NumConversion.bytesToShort(bytes, offset));
	}
	
	@Test
	public void testShortToBytes() {
		Object[][] testCases = {
			{short_min,     32_639, short_max,    0, short_max,    short_max},
	...
	private void checkShortToBytes(short value, byte[] bytes, byte[] expected, int offset, byte[] offsetExpected, byte[] littleEndianOffsetExpected) {
		String testName = "shortToBytes";
		String bytesString = createToString(bytes);
		
		byte[] actual = NumConversion.shortToBytes(value);
		assertArrayEquals(getTestMessage(testName, value, createToString(expected), createToString(actual)), expected, actual);
		
		byte[] bytesCopy = copy(bytes);
		NumConversion.shortToBytes(value, bytesCopy, offset);
		assertArrayEquals(getTestMessage(testName, bytesString, offset, value, createToString(offsetExpected), createToString(bytesCopy)), offsetExpected, bytesCopy);
		
		byte[] bytesCopy2 = copy(bytes);
		NumConversion.shortToBytesLittleEndian(value, bytesCopy2, offset);
		assertArrayEquals(getTestMessage(testName, bytesString, offset, value, createToString(littleEndianOffsetExpected), createToString(bytesCopy2)), littleEndianOffsetExpected, bytesCopy2);
	}
	...
	public void testBytesToUnsignedShort() {
		Object[][] testCases = {
			{short_min,     0, 32_896},
			{short_negOne,  0, 65_535},
			{short_zero,    0,      0},
			{short_one,     0,    257},
			{short_max,     0, 32_639},
			{byte_minToMax, 0, 33_023},
			{byte_minToMax, 2,      1},
			{byte_minToMax, 3,    383},
		};
	...
	private void checkBytesToUnsignedShort(byte[] bytes, int offset, int offsetExpected) {
		...
		String bytesString = createToString(bytes);
		assertEquals(getTestMessage(testName, bytesString, offset, offsetExpected), offsetExpected, NumConversion.bytesToUnsignedShort(bytes, offset));
	}
	
	@Test
	public void testUnsignedShortToBytes() {
		Object[][] testCases = {
			{short_min,    32_639, 0, short_max},
			{short_negOne,    257, 0, short_one},
			{short_zero,        0, 0, short_zero},
			{short_one,    65_535, 0, short_negOne},
			{short_max,    32_896, 0, short_min},

			{long_neg5To5, 10_000, 0, short_tenThousandOffset0},
			{long_neg5To5, 10_000, 6, short_tenThousandOffset6},
	...
	public void testBytesToInt() {
		Object[][] testCases = {
			{int_min,     -2_139_062_144, 0, -2_139_062_144, -2_139_062_144, -2_139_062_144},
			{int_negOne,              -1, 0,             -1,             -1,             -1},
			{int_zero,                 0, 0,              0,              0,              0},
	...
	private void checkBytesToInt(byte[] bytes, int expected, int offset, int offsetExpected, int littleEndianExpected, int littleEndianOffsetExpected) {
		String testName = "bytesToInt";
		String bytesString = createToString(bytes);
		assertEquals(getTestMessage(testName, bytesString),                           expected, NumConversion.bytesToInt(bytes));
		assertEquals(getTestMessage(testName, bytesString, offset),             offsetExpected, NumConversion.bytesToInt(bytes, offset));
		assertEquals(getTestMessage(testName, bytesString),               littleEndianExpected, NumConversion.bytesToIntLittleEndian(bytes));
		assertEquals(getTestMessage(testName, bytesString, offset), littleEndianOffsetExpected, NumConversion.bytesToIntLittleEndian(bytes, offset));
	}
	...
	public void testIntToBytes() {
		...
		Object[][] testCases = {
			{int_min,     2_139_062_143, int_max,    0, int_max,    int_max},
			{int_negOne,     16_843_009, int_one,    0, int_one,    int_one},
			{int_zero,                0, int_zero,   0, int_zero,   int_zero},
	...
	private void checkIntToBytes(int value, byte[] bytes, byte[] expected, int offset, byte[] offsetExpected, byte[] littleEndianOffsetExpected) {
	...
	public void testBytesToLong() {
		Object[][] testCases = {
			{long_min,     0, -9_187_201_950_435_737_472L, -9_187_201_950_435_737_472L, -9_187_201_950_435_737_472L, -9_187_201_950_435_737_472L},
			{long_negOne,  0,                         -1L,                         -1L,                         -1L,                         -1L},
			{long_zero,    0,                          0L,                          0L,                          0L,                          0L},
			{long_one,     0,     72_340_172_838_076_673L,     72_340_172_838_076_673L,     72_340_172_838_076_673L,     72_340_172_838_076_673L},
			{long_max,     0,  9_187_201_950_435_737_471L,  9_187_201_950_435_737_471L,  9_187_201_950_435_737_471L,  9_187_201_950_435_737_471L},
			{long_neg5To5, 0,   -289_077_004_416_843_518L,   -289_077_004_416_843_518L,    144_397_762_547_285_243L,    144_397_762_547_285_243L},
			{long_neg5To5, 2,   -289_077_004_416_843_518L,   -144_397_762_547_285_244L,    144_397_762_547_285_243L,    289_077_004_416_843_517L},
			{long_neg5To5, 3,   -289_077_004_416_843_518L,    -72_339_064_685_919_227L,    144_397_762_547_285_243L,    361_417_177_238_142_974L},
		};
	...
	private void checkBytesToLong(byte[] bytes, long expected, int offset, long offsetExpected, long littleEndianExpected, long littleEndianOffsetExpected) {
		String testName = "bytesToLong";
		String bytesString = createToString(bytes);
		assertEquals(getTestMessage(testName, bytesString),                           expected, NumConversion.bytesToLong(bytes));
		assertEquals(getTestMessage(testName, bytesString, offset),             offsetExpected, NumConversion.bytesToLong(bytes, offset));
		assertEquals(getTestMessage(testName, bytesString),               littleEndianExpected, NumConversion.bytesToLongLittleEndian(bytes));
		assertEquals(getTestMessage(testName, bytesString, offset), littleEndianOffsetExpected, NumConversion.bytesToLongLittleEndian(bytes, offset));
	}
	...
	public void testLongToBytes() {
		...
		Object[][] testCases = {
			{long_min,     9_187_201_950_435_737_471L, long_max,    0, long_max,    long_max},
	...
	private void checkLongToBytes(long value, byte[] bytes, byte[] expected, int offset, byte[] offsetExpected, byte[] littleEndianOffsetExpected) {
...
//			{long_neg5To5, 3,   -289_077_004_416_843_518L,    -72_339_064_685_919_227L},
		...
		for (Object[] testCase : testCases) {
			...
			String bytesString = createToString(bytes);
			assertArrayEquals(getTestMessage(testName, bytesString, createToString(actualDoubleToBytes)),         bytes, actualDoubleToBytes);
...
//		String bytesString = createToString(bytes);
//		assertEquals(getTestMessage(testName, bytesString),                               expected, NumConversion.bytesToDouble(bytes),         0);
//		assertEquals(getTestMessage(testName, bytesString, offset, offsetExpected), offsetExpected, NumConversion.bytesToDouble(bytes, offset), 0);
//	}
//	
...
//	}
	...
	public void testIntsToLong() {
		...
		Object[][] testCases = {
			{int_minVal, int_minVal, -9_223_372_034_707_292_160L},
			{-1,                 -1, 						 -1L},
			{ 0,                  0,                          0L},
			{ 1,                  1,              4_294_967_297L},
			{int_maxVal, int_maxVal,  9_223_372_034_707_292_159L},
	...
	public void testParseHexStringAsUnsignedLong() {
		Object[][] testCases = {
			{"1000000000000000", 1_152_921_504_606_846_976L},
			{"FFFFFFFFFFFFFFFF",                        -1L},
			{"0",                                        0L},
			{"0000000000000001",                         1L},
			{"0FFFFFFFFFFFFFFF", 1_152_921_504_606_846_975L},
		};
