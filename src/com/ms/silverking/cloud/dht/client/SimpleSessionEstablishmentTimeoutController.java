...
public class SimpleSessionEstablishmentTimeoutController implements
		SessionEstablishmentTimeoutController {
    ...
    private static final SimpleSessionEstablishmentTimeoutController    template = 
    						new SimpleSessionEstablishmentTimeoutController(defaultMaxAttempts,
    								defaultAttemptRelativeTimeoutMillis, defaultMaxRelativeTimeoutMillis);

	static {
		ObjectDefParser2.addParser(template);
	}        
	
	public SimpleSessionEstablishmentTimeoutController(int maxAttempts, int attemptRelativeTimeoutMillis, int maxRelativeTimeoutMillis) {
    ...
    public SimpleSessionEstablishmentTimeoutController maxAttempts(int maxAttempts) {
        return new SimpleSessionEstablishmentTimeoutController(maxAttempts, attemptRelativeTimeoutMillis, maxRelativeTimeoutMillis);
    }
