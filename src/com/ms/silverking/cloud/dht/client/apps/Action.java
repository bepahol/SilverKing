...
enum Action {
    Put, PutRandom("px"), Invalidation, Get, GetMeta, GetValueAndMeta("gm"), WaitFor("w"), Snapshot(false), SyncRequest(false), 
            CreateNamespace(false), GetNamespaceOptions(false), 
