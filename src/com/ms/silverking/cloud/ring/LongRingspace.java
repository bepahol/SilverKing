...
public class LongRingspace {
    ...
    public static long mapChildRegionspacePointToParentRegion(RingRegion childRegionspace, long p, RingRegion parentRegion) {
        long   mp;
        
        mp = newBD(p - childRegionspace.getStart()).multiply(parentRegion.getSizeBD()).divide(childRegionspace.getSizeBD(), mathContext).add(newBD(parentRegion.getStart())).longValue();
        return mp;
    }
        

    public static RingRegion mapChildRegionToParentRegion(RingRegion childRegionspace, RingRegion childRegion, RingRegion parent) {
        long    mStart;
        long    mEnd;
	...
	public static void main(String[] args) {
		try {
            ...
            System.out.println(mapChildRegionToParentRegion(new RingRegion(0,100), new RingRegion(0,49), new RingRegion(0, 49)));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
